...
const ConnectButton: React.FC<Props> = () => {
  ...
  return (
    <button
      className={
        "rounded-lg bg-connect_wallet tracking-wider duration-150 hover:bg-black hover:text-white border-black/10 border transition px-3 py-1 sm:px-5 sm:py-2 lg:px-8 lg:py-3.5 text-white font-semibold select-none text-sm sm:text-base"
      }
      onClick={open}
    >
